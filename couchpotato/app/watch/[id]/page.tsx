...
import { Avatar, Box, Container } from "@radix-ui/themes";
...
export default function WatchPage({
	...
	return (
		<Box
			...
			style={{
				backgroundImage: `url(${TMDB.OriginalImageUrl}${content.backdropPath})`,
			}}>
					...
					<div className="lg:col-span-2 space-y-6">
						...
						<div className="bg-gray-800 rounded-lg p-6">
							<Tabs.Root defaultValue="english">
								...
								<Tabs.Content
									value="english"
									className="space-y-2 grid grid-cols-2 md:grid-cols-3 gap-2">
									{availableSources
